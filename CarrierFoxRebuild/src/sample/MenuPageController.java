...
public class MenuPageController extends AnchorPane
{
    ...
    private Button clearConversation;
    ...
    public Group initializePage(Stage primaryStage, UserData userData, HTTPRequest httpRequest, Language language) throws IOException
    {
        ...
        AnchorPane chatSettingsPane = (AnchorPane) root.getChildrenUnmodifiable().get(3);
        HBox clearChatHBox = (HBox) chatSettingsPane.getChildren().get(0);
        clearConversation = (Button) clearChatHBox.getChildren().get(0);
    ...
    public void returnHome() throws IOException
    {
        ...
        Scene newScene = new Scene(defaultPageController.initializeDefaultPage(primaryStage, userData, httpRequest, language));
