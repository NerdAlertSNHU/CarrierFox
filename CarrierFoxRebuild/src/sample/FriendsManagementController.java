...
public class FriendsManagementController extends AnchorPane
{
    ...
    public Group initializeFriendsManagementPage(Stage primaryStage, UserData userData, HTTPRequest httpRequest, Language language) throws IOException
    {
        ...
        HBox addFriendButtonHBox = (HBox) addFriendAnchor.getChildren().get(0);
        this.addFriendButton = (Button) addFriendButtonHBox.getChildren().get(0);

        HBox addFriendInputBox = (HBox) addFriendAnchor.getChildren().get(1);
        this.addFriendField = (TextField) addFriendInputBox.getChildren().get(0);
    ...
    public void submitAddFriendRequest()
    {
        ...
        addFriendRequest(addFriendField.getText());
