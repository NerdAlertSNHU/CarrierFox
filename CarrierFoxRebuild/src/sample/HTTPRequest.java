...
public class HTTPRequest
{
    ...
    public void openWebSocket(ScrollPane messagesScrollPane, Text stringTextWidth, UserData userData, int threadId)
    {
        try
        {
            WebSocketController chatclient = new WebSocketController(new URI("wss://yoururlhere.com/"), messagesScrollPane, stringTextWidth, userData, threadId);
    ...
    {
        String url = "https://yoururlhere.com/api/thread/" + threadId + "/messages/";
    ...
    {
        String url = "https://yoururlhere.com/api/login/";
    ...
    {
        String url = "https://yoururlhere.com/api/create-account";
    ...
    {
        String url = "https://yoururlhere.com/api/friends";
    ...
    {
        String url = "https://yoururlhere.com/api/add-friend";
        List<String> paramTypes = new ArrayList<>();
        List<String> params = new ArrayList<>();
    ...
    {
        String url = "https://yoururlhere.com/api/remove-friend";
        List<String> paramTypes = new ArrayList<>();
        List<String> params = new ArrayList<>();
    ...
    {
        String url = "https://yoururlhere.com/api/change-email";
        List<String> paramTypes = new ArrayList<>();
        List<String> params = new ArrayList<>();
    ...
    {
        String url = "https://yoururlhere.com/api/change-password";
        List<String> paramTypes = new ArrayList<>();
        List<String> params = new ArrayList<>();
    ...
    {
        String url = "https://yoururlhere.com/api/settings/save";
        List<String> paramTypes = new ArrayList<>();
        List<String> params = new ArrayList<>();
    ...
    {
        String url = "https://yoururlhere.com/api/settings/";
    ...
    {
        String url = "https://yoururlhere.com/api/thread/clear-messages";
    ...
    {
        String url = "https://yoururlhere.com/api/thread/settings";
    ...
    public Thread createThread(List<String> users, String username)
    {
        ...
        String url = "https://yoururlhere.com/api/create-thread";
...
//        fullResponse = fullResponse.replace("[", "");
//        fullResponse = fullResponse.replace("]", "");
//        fullResponse = fullResponse.replaceAll("[\[\"(a-zA-Z)+\"\]]", "")
        //fullResponse = fullResponse.substring(1, fullResponse.length() - 1);
        //fullResponse = fullResponse.replace("\"users\":[", "");
