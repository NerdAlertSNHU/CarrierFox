...
func getMessages(threadID:Int, completionHandler: @escaping (Data) -> Void){
    let url = URL(string: "https://yoururlhere/api/thread/\(threadID)/messages")
    guard url != nil else {
...
func sendMessage(myMessage: String){
    let url = URL(string: "https://yoururlhere/api/thread/1/message/add")
    guard url != nil else {
        print("Error creating url object")
        return
    }
...
func deleteMessage(messageID: String, threadID: Int){
    let url = URL(string: "https://yoururlhere/api/message/delete")
    guard url != nil else {
        print("Error creating url object")
        return
    }
